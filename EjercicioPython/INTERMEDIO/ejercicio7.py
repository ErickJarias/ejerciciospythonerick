...
def main():
    inventario = InventarioModificado()
    producto1 = ProductoModificado("008", "Producto 1", 30, 90, 7, 90, "Proveedor 1")
    producto2 = ProductoModificado("009", "Producto 2", 55, 85, 7, 90, "Proveedor 2")
